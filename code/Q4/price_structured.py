"""Causal 0:00 price forecast: expanding same-slot mean + weekday residual + 7-day residual mean."""
...
def forecast_hat0(
    ...
    """b(d)=mean_{j<d} p(j); weekday residual; recent-7 equal residual mean.

    Day 0 b uses attachment-1 cold_start only. After that, b uses actual prices.
    """
